...
// create a webcomponent "web-gallery-data"
// create a custom event each time you click on an item in the gallery
// it need to update the web-gallery-detail with the respected data of the selected item
// select the web-gallery and show the web-gallery-detail

//the template of my gallery-detail:

class WebGalleryData extends HTMLElement {
    constructor() {
      super();
    ...
    initGallery() {
      const galleryContainer = this.shadowRoot.getElementById("gallery-container");
    
      this.galleryItems.forEach((item) => {
        const galleryItem = document.createElement("div");  
        galleryItem.className = "gallery-item";
        galleryItem.id = `gallery-item-${item.id}`;  
        galleryItem.innerText = item.title;
        galleryItem.addEventListener("click", () => this.dispatchEvent(new CustomEvent("item-selected", { detail: item })));
  ...
  window.customElements.define("web-gallery-data", WebGalleryData);
  class WebGalleryDetail extends HTMLElement {
    constructor() {
      ...
      this.detailContainer = this.shadowRoot.getElementById("detail-container");
  
      this.addEventListener("item-selected", this.updateDetail.bind(this));
    }
  ...
  window.customElements.define("web-gallery-detail", WebGalleryDetail);